...
public class Distribuidores_tabla extends JFrame {
    ...
    private void jpanelbtn1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jpanelbtn1MousePressed
        try {
            ...
            form.Editandolo = false;
            form.limpiar();
            form.btnDistribuidor.setBackground(new Color(0, 110, 53));
            form.jLabel18.setText("Agregar Distribuidor");
    ...
    private void jpanelbtn6MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jpanelbtn6MousePressed
        try {
            ...
            form.setVisible(true);
            form.Editandolo = true;
            form.limpiar();
            modelo.setCelda(Tabla.getSelectedRow());
            form.btnDistribuidor.setBackground(new Color(170, 167, 30));
